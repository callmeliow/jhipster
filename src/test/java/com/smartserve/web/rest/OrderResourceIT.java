...
import com.smartserve.repository.OrderRepository;
import com.smartserve.service.dto.OrderDTO;
import com.smartserve.service.mapper.OrderMapper;
...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().orderDate(DEFAULT_ORDER_DATE).totalAmount(DEFAULT_TOTAL_AMOUNT);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().orderDate(UPDATED_ORDER_DATE).totalAmount(UPDATED_TOTAL_AMOUNT);
        return order;
    }
