...
import com.smartserve.service.FoodService;
...
/**
 * REST controller for managing {@link com.smartserve.domain.Food}.
 */
@RestController
...
public class FoodResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<FoodDTO>> getAllFoods(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
