...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './custom.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUSTOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOM actions', async () => {
      const expectedActions = [
        {
