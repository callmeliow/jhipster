...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERCUSTOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERCUSTOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERCUSTOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERCUSTOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERCUSTOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERCUSTOM actions', async () => {
      const expectedActions = [
        {
