...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERSTAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERSTAGE actions', async () => {
      const expectedActions = [
        {
