...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './order-item-custom.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERITEMCUSTOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERITEMCUSTOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERITEMCUSTOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERITEMCUSTOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERITEMCUSTOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERITEMCUSTOM actions', async () => {
      const expectedActions = [
        {
