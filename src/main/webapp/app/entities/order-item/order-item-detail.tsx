    ...
    <Row>
      <Col md="8">
        <h2 data-cy="orderItemDetailsHeading">
          <Translate contentKey="smartServeApp.orderItem.detail.title">OrderItem</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="smartServeApp.orderItem.food">Food</Translate>
          </dt>
          <dd>{orderItemEntity.food ? orderItemEntity.food.id : ''}</dd>
          <dt>
            <Translate contentKey="smartServeApp.orderItem.orderStage">Order Stage</Translate>
          </dt>
          <dd>{orderItemEntity.orderStage ? orderItemEntity.orderStage.id : ''}</dd>
        </dl>
