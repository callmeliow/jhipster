...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './food.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOOD_LIST actions', async () => {
    ...
    it('dispatches FETCH_FOOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOOD actions', async () => {
      const expectedActions = [
        {
