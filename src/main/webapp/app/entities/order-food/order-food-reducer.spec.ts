...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERFOOD_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERFOOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERFOOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERFOOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERFOOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERFOOD actions', async () => {
      const expectedActions = [
        {
